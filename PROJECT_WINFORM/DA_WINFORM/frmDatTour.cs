...
namespace DA_WINFORM
{
    public partial class frmDatTour : Form
    {
        ...
        private void dgvTour_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            TTTourfrm.rtbMoTa.Text = dttable.Rows[0]["MOTA"].ToString();
            ...
            int soLuongConLai = Convert.ToInt32(dttable.Rows[0]["SOLUONGCONLAI"]);
           
            if (Convert.ToDouble(calDays.TotalDays) <= 1 || soLuongConLai == 0)
            {
